...
public class ClientConsoleController extends BaseController {
    ...
    public ClientConsoleController(Context context, Map<String, Curve> curves) {
        super(context);
    ...
    public void run() {
        ...
        while (true) {
            ...
            AndroidController controller = new AndroidController(this.context, selectedCurve);

            controller.processGpx();
